...
$app->post('/api/MicrosoftContentModerator/getImageListDetails', function ($request, $response) {
    ...
    $query_str = "https://{$data['availableApi']}.api.cognitive.microsoft.com/contentmoderator/lists/v1.0/imagelists/{$data['listId']}";
